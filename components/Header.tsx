  ...
  return (
    <header className="flex flex-row justify-between items-center h-26 lg:mb-8 lg:border-b lg:border-b-[hsl(var(--grayish-blue))] ">
      ...
      <div className="flex flex-row items-center justify-center gap-8 h-full">
        <button className="relative group cursor-pointer" onClick={showCartNow} type="button">
          {cartQuantity > 0 && (
            <div className="absolute -top-2 -right-2 bg-[hsl(var(--orange))] text-[hsl(var(--white))] w-5 h-4 rounded-lg flex items-center justify-center text-xs font-bold z-39">
              {cartQuantity}
            </div>
          )}
          <div>
